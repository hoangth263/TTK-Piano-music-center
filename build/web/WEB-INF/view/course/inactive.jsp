                        ...
                        <tbody>
                            ...
                            <c:forEach var="course" items="${list}"  begin="${20*(page-1)}" end="${20*page - 1}">
                                <tr>
                                    ...
                                    <a href="<c:url value="/course/active.do?couId=${course.couId}&page=${page}"/>" style="color: black"><button>Active</button></a>
                                    <a href="<c:url value="/course/delete.do?couId=${course.couId}&page=${page}"/>" style="color: black"><button>Delete</button></a>
                                    </td>
