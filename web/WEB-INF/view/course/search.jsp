            ...
            <div class="row">
                ...
                <c:if test="${list != null}">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="course" items="${list}"  begin="${20*(page-1)}" end="${20*page - 1}">
                                <tr>
                                    ...
                                    <a href="<c:url value="/course/inactive.do?couId=${course.couId}&category=search&page=${page}"/>" style="color: black"><button>Deactive</button></a>
                    ...
                    <div class="pagination">
                        ...
                        <c:if test="${page>1}" >
                            <a href="<c:url value="/course/search.do?search=${search}&page=${page-1}"/>">&laquo;</a>
                        </c:if>
                        <a <c:if test="${page==1}" >class="active"</c:if> href="<c:url value="/course/search.do?search=${search}&page=1"/>">1</a>
                        <c:if test="${paging>20}">
                            <c:set var="next" value="2"/>
                            <a <c:if test="${page==2}" >class="active"</c:if> href="<c:url value="/course/search.do?search=${search}&page=2"/>">2</a>
                        </c:if>
                        <c:if test="${paging>40}">
                            <c:set var="next" value="3"/>
                            <a <c:if test="${page==3}" >class="active"</c:if> href="<c:url value="/course/search.do?search=${search}&page=3"/>">3</a>
                        </c:if>
                        <%--<c:if test="${paging>20}">--%>
                    <!--            <a <c:if test="${page==4}" >class="active"</c:if> href="#">4</a>
                        <a <c:if test="${page==5}" >class="active"</c:if> href="#">5</a>-->
                            <!--                <a href="#">6</a>-->
                        <c:if test="${next!=page}">
                            <a href="<c:url value="/course/search.do?search=${search}&page=${page+1}"/>">&raquo;</a>
                        </c:if>
                    </div>
                </c:if>
                <c:if test="${list == null}">
